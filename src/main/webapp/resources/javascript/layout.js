...
//Comentados para não deixar o botão bloqueado apenas um erro e padronizar o bloqueio da tela toda como no resto do sistema
function blockButton(campo) {
//	try {
//		document.getElementById(campo).disabled=true;
//		document.getElementById(campo).firstChild.innerHTML ="Aguarde...";
//		document.getElementById(campo).classList.add('ui-state-disabled');
//	} catch (err) { }
}
